...
__all__ = [
    'DISPID_SOTIsUISupported', 'eLEXTYPE_RESERVED8',
    'SGPronounciation', 'SAFT48kHz8BitStereo', 'SpeechGrammarState',
    'eLEXTYPE_PRIVATE15', 'SPVPRI_NORMAL', 'SAFT11kHz16BitMono',
    'ISpeechGrammarRule', 'DISPID_SPIEngineId',
    'DISPID_SPEActualConfidence', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SDKSetBinaryValue', 'SRTEmulated', 'DISPID_SRGRules',
    'SPEI_INTERFERENCE', 'SAFTCCITT_ALaw_44kHzMono',
    'eLEXTYPE_PRIVATE9', 'DISPID_SVResume', 'ISpeechObjectToken',
    'DISPID_SVPriority', 'DISPID_SRGDictationLoad',
    'eLEXTYPE_RESERVED6', 'SAFT24kHz16BitMono', 'SVF_Emphasis',
    'SRCS_Disabled', 'DISPID_SRSAudioStatus', 'SPEI_TTS_BOOKMARK',
    '__MIDL_IWinTypes_0009', 'SPAUDIOSTATE', 'SPRST_ACTIVE_ALWAYS',
    'SP_VISEME_0', 'DISPID_SLWPronunciations', 'DISPID_SVVoice',
    'SVEEndInputStream', 'DISPID_SRRAlternates', 'tagSPPROPERTYINFO',
    'SpeechBookmarkOptions', 'SRTAutopause', 'SRSEIsSpeaking',
    'SP_VISEME_17', 'SpeechRegistryLocalMachineRoot',
    'SPADAPTATIONRELEVANCE', 'DISPID_SDKOpenKey',
    'SPEI_END_INPUT_STREAM', 'SPEI_FALSE_RECOGNITION',
    'SSFMOpenForRead', 'SPEI_HYPOTHESIS', 'DISPID_SADefaultFormat',
    'DISPID_SPIProperties', 'ISpeechResourceLoader', 'DISPID_SGRName',
    'SPDKL_DefaultLocation', 'DISPID_SGRSTsItem',
    'SpCompressedLexicon', 'IEnumString', 'DISPID_SLGetWords',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPIStartTime',
    'ISpeechCustomStream', 'ISpeechRecoResultTimes', 'SITooLoud',
    'SDTProperty', 'DISPID_SpeechPhraseReplacement', 'SpMMAudioIn',
    'SPEI_SENTENCE_BOUNDARY', 'SpeechLexiconType',
    'SpeechRecoContextState', 'SSTTTextBuffer', 'SPAR_Medium',
    ...
    'DISPID_SVSkip', 'DISPID_SPPName',
    'DISPID_SPAStartElementInResult', 'SPGS_ENABLED',
    'DISPID_SRCCreateGrammar', 'SREPhraseStart',
    'DISPID_SGRInitialState', 'DISPID_SLGetGenerationChange',
    'SPFM_NUM_MODES', 'DISPID_SABIMinNotification', 'SRCS_Enabled',
    'DISPID_SPAsItem', 'DISPID_SGRAddResource',
    'DISPID_SpeechPhraseElement', 'SPEI_START_SR_STREAM',
    'DISPIDSPTSI', 'DISPID_SpeechPhraseElements', 'DISPID_SVRate',
    'DISPID_SRIsShared', 'SPSERIALIZEDPHRASE', 'DISPID_SRGetFormat',
    'DISPID_SLWWord', 'SECFIgnoreCase', 'SpeechCategoryAppLexicons',
    'DISPID_SPRuleEngineConfidence', 'SDTAudio',
    'DISPID_SVSInputSentenceLength', 'SRERequestUI',
    'ISpeechRecoResult', 'DISPID_SLAddPronunciation',
    'DISPID_SpeechVoice', 'DISPID_SDKDeleteKey', 'SpeechAllElements',
    'SRADefaultToActive', 'SPPS_LMA', 'DISPID_SGRClear',
    'SPRECORESULTTIMES', 'DISPID_SpeechPhraseAlternate',
    'SAFT12kHz16BitStereo', 'SP_VISEME_5', 'SVSFUnusedFlags',
    'DISPID_SPIAudioSizeTime', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRCEBookmark', 'SpCustomStream', 'ISpeechPhoneConverter',
    'SGRSTTRule', 'SAFT24kHz16BitStereo', 'SpMMAudioEnum',
    'SpeechCategoryRecoProfiles', 'SPINTERFERENCE', 'SPAO_NONE',
    'SpeechVoiceSpeakFlags', 'SPSNoun', 'ISpeechFileStream',
    'SpeechDictationTopicSpelling', 'SPEI_VISEME',
    'DISPID_SGRSTWeight', 'ISpRecoContext', 'SpInProcRecoContext',
    'DISPID_SRRGetXMLResult', 'DISPID_SRIsUISupported',
    'SPINTERFERENCE_TOOFAST', 'SVP_20', 'SGSEnabled', 'SGSExclusive',
    'DISPID_SpeechVoiceStatus', 'DISPID_SPEEngineConfidence',
    'SAFTGSM610_44kHzMono', 'SVSFPersistXML', 'DISPID_SPCIdToPhone',
    'DISPID_SpeechPhraseReplacements', 'SDKLLocalMachine', 'SDTAll',
    'SPEI_END_SR_STREAM', 'DISPID_SWFESamplesPerSec',
    'SPRECOGNIZERSTATUS', 'SPBO_PAUSE', 'DISPID_SRGId',
    'DISPID_SRRTimes', 'DISPID_SGRSTransitions', 'SDTDisplayText',
    'DISPID_SRGCmdLoadFromObject', 'SpeechCategoryRecognizers',
    'SPBINARYGRAMMAR', 'SPCT_COMMAND', 'DISPID_SpeechGrammarRule',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SRCRequestedUIType',
    '_SPAUDIOSTATE', 'SP_VISEME_18', 'SVP_7', 'DISPID_SPRText',
    'DISPID_SPRulesItem', 'ISpeechWaveFormatEx', 'SVP_6',
    'SSTTWildcard', 'eLEXTYPE_PRIVATE1', 'ISpeechPhraseReplacements',
    'SREStreamEnd', 'DISPID_SVEPhoneme',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SGRSTNextState',
    'SVP_2', 'eLEXTYPE_PRIVATE8', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpeechPhraseReplacement', 'DISPID_SVVolume', 'SpVoice',
    'eLEXTYPE_PRIVATE16', 'eWORDTYPE_DELETED', 'SPCT_SUB_COMMAND',
    'DISPID_SGRSAddRuleTransition', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SVEVoiceChange', 'DISPID_SpeechRecoContextEvents',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SpeechVoiceEvent',
    'SPWORD', 'DISPID_SPEsCount', 'DISPID_SWFEBlockAlign',
    'DISPID_SRCEEnginePrivate', 'DISPID_SABufferNotifySize',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SGRs_NewEnum',
    'DISPID_SDKEnumKeys', 'Library', 'SPRULESTATE',
    'SpeechAudioFormatGUIDText', 'SRTSMLTimeout', 'SGRSTTEpsilon',
    'SPEI_VOICE_CHANGE', 'DISPID_SPRules_NewEnum', 'SP_VISEME_20',
    'SWPUnknownWordPronounceable', 'SAFT24kHz8BitMono',
    'SAFT32kHz8BitMono', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'ISpeechPhraseElements', 'SPEI_RESERVED6',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpObjectToken',
    'DISPID_SOTMatchesAttributes', 'SREFalseRecognition',
    'DISPID_SRGetPropertyString', 'SPRS_INACTIVE', 'SPBO_TIME_UNITS',
    'SFTSREngine', 'DISPID_SBSFormat', 'ISpeechMMSysAudio',
    'SGLexicalNoSpecialChars', 'SPEI_RECOGNITION',
    'SDA_One_Trailing_Space', 'SLOStatic', 'ISpeechVoiceStatus',
    'SVESentenceBoundary', 'SpStream', 'Speech_Max_Word_Length',
    'SpeechPropertyNormalConfidenceThreshold',
    'SpPhoneticAlphabetConverter', 'SRTStandard', 'DISPID_SLPLangId',
    'SRAImport', 'DISPID_SVSVisemeId', 'SPAUDIOSTATUS',
    'DISPID_SGRAttributes', 'DISPID_SRCRetainedAudioFormat',
    'SGSDisabled', 'DISPID_SRCEAudioLevel',
    'DISPID_SPRDisplayAttributes', 'SpeechAddRemoveWord',
    'DISPID_SRCRecognizer', 'DISPID_SGRSRule', 'SECLowConfidence',
    'DISPID_SVEViseme', 'SPWF_INPUT', 'ISpProperties', 'SPPS_Noun',
    'SVP_10', 'DISPID_SPEAudioTimeOffset', 'SPSERIALIZEDRESULT',
    'SWTAdded', 'SECNormalConfidence', 'ISpeechPhraseAlternate',
    'DISPID_SGRSTPropertyName', 'SVSFNLPMask',
    'DISPID_SVSLastBookmarkId', 'SpeechVoiceEvents', 'DISPID_SOTCId',
    'SDKLDefaultLocation', 'SPEI_RESERVED5', 'SRAExport', 'SVP_12',
    'SpeechSpecialTransitionType', 'DISPID_SGRId',
    'DISPID_SRRAudioFormat', 'SPEI_RESERVED1',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRCEPhraseStart', 'SAFT22kHz8BitStereo', 'SP_VISEME_7',
    'STCInprocServer', 'SECFNoSpecialChars', 'SVEAudioLevel',
    'DISPID_SOTsItem', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SGDSActive', 'DISPID_SRCERecognizerStateChange', 'SPWORDTYPE',
    'eLEXTYPE_PRIVATE17', 'DISPID_SOTCSetId', 'eLEXTYPE_APP',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SpeechRecognizer',
    'SVEViseme', 'SRSInactiveWithPurge', 'eLEXTYPE_PRIVATE3', 'SVP_3',
    'SECFEmulateResult', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SMSALineId', 'DISPID_SVSLastStreamNumberQueued',
    'SPFM_CREATE_ALWAYS', 'DISPID_SRCRetainedAudio',
    'eLEXTYPE_PRIVATE13', 'Speech_Default_Weight', 'SPEI_MAX_TTS',
    'ISpeechLexiconPronunciation', 'SpeechEmulationCompareFlags',
    'SpSharedRecognizer', 'DISPID_SRRRecoContext',
    'DISPID_SASetState', 'DISPID_SVEWord', 'SPLO_DYNAMIC',
    'DISPID_SPIGetText', 'tagSPTEXTSELECTIONINFO',
    'SAFT44kHz8BitStereo', 'DISPID_SpeechRecoResult2', 'SVP_4',
    'SPEI_RECO_STATE_CHANGE', 'ISpeechPhraseInfo', 'SPCATEGORYTYPE',
    'DISPID_SVGetVoices', 'DISPID_SRCERecognitionForOtherContext',
    'ISpSerializeState', 'DISPID_SVEStreamStart', 'IStream',
    'SWTDeleted', 'LONG_PTR', 'DISPID_SDKEnumValues', 'SITooSlow',
    'SPSModifier', 'SP_VISEME_1', 'SASPause', 'DISPID_SOTs_NewEnum',
    'DISPID_SRCEventInterests', 'ISpPhrase', 'SPCS_ENABLED',
    'SPINTERFERENCE_NONE', 'ISpeechGrammarRuleState', 'SREAdaptation',
    'SBONone', 'SDTReplacement', 'SSTTDictation', 'SpMemoryStream',
    'DISPID_SPILanguageId', 'DISPID_SRRDiscardResultInfo',
    'eLEXTYPE_PRIVATE5', 'ISpRecoContext2', 'ISpObjectToken',
    'SPBO_AHEAD', 'DISPID_SCSBaseStream', 'IEnumSpObjectTokens',
    'SpeechAudioVolume', 'SREInterference', 'SPDKL_CurrentUser',
    'SPPS_Verb', 'DISPID_SLGetPronunciations', 'SP_VISEME_8',
    'SVEPrivate', 'SAFT22kHz16BitStereo', 'ISpeechRecognizer',
    'DISPID_SPRuleConfidence', 'SAFTGSM610_8kHzMono',
    'DISPID_SpeechLexiconProns', 'SAFT44kHz8BitMono',
    'SpeechWordType', 'SGLexical', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SWFEChannels', 'SDA_Consume_Leading_Spaces', 'SVP_17',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SPAPhraseInfo',
    'SpeechRecognitionType', 'SAFTADPCM_44kHzStereo', 'SP_VISEME_10',
    'SPSHT_Unknown', 'STCRemoteServer', 'SPEI_RESERVED2',
    'DISPID_SAStatus', 'eLEXTYPE_PRIVATE14', 'STCAll',
    'SpeechRecoProfileProperties', 'SPRST_NUM_STATES', 'typelib_path',
    'SRAInterpreter', 'SINoSignal', 'ISpeechPhraseProperties',
    'SAFTGSM610_22kHzMono', 'ISpeechBaseStream', 'DISPID_SFSOpen',
    'SRESoundStart', 'SpSharedRecoContext', 'ISpRecoCategory',
    'DISPID_SRProfile', 'ISpeechXMLRecoResult',
    ...
    'DISPID_SPPs_NewEnum', 'ISpeechPhraseAlternates', 'SPWT_LEXICAL',
    'DISPID_SGRsCommit', 'SRAORetainAudio', 'SGRSTTDictation',
    'DISPID_SPIEnginePrivateData', 'SREStreamStart',
    'SpeechTokenKeyUI', 'DISPID_SPPParent', 'SPVPRIORITY',
    'SVEVoiceChange', 'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechPhraseProperty', 'SREBookmark', 'SPCT_DICTATION',
    'ISpeechRecoResult2', 'SPEVENTENUM', 'DISPID_SRRecognizer',
    'DISPID_SRRTStreamTime', 'ISpeechAudioFormat',
    'DISPID_SVAlertBoundary', 'ISpAudio', 'SpeechGrammarWordType',
    'DISPID_SABIBufferSize', 'DISPID_SDKDeleteValue',
    'ISpeechTextSelectionInformation', 'DISPID_SRCSetAdaptationData',
    'SP_VISEME_9', 'DISPID_SRRSetTextFeedback',
    'DISPID_SRCCreateResultFromMemory', 'SVP_8', 'SVSFVoiceMask',
    'DISPID_SPEDisplayText', 'DISPID_SRCEInterference', 'SVP_18',
    'SDA_No_Trailing_Space', 'ISpeechAudio', 'SPAS_CLOSED',
    'ISpNotifySource', 'STCLocalServer', 'DISPID_SPRuleName',
    'DISPID_SPPBRestorePhraseFromMemory', 'SPSUnknown',
    'DISPID_SRCERecognition', 'SPEI_PROPERTY_STRING_CHANGE', 'SVP_14',
    'SPXMLRESULTOPTIONS', 'SVEStartInputStream',
    'SREPropertyStringChange', 'DISPID_SPCLangId',
    'DISPID_SRAudioInputStream', 'DISPID_SVStatus', 'SGDisplay',
    'SREAllEvents', 'SpInprocRecognizer',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SpeechStreamFileMode',
    'ISpDataKey', 'SAFTADPCM_8kHzMono', 'SpStreamFormatConverter',
    'IInternetSecurityMgrSite', 'SAFTNoAssignedFormat',
    'DISPID_SMSAMMHandle', 'DISPID_SLPPhoneIds', 'SPVOICESTATUS',
    'DISPID_SRRTOffsetFromStart', 'ISpEventSource', 'SPGS_DISABLED',
    'DISPID_SpeechObjectTokens', 'SPEI_PHRASE_START',
    'SPWORDPRONUNCIATION', 'DISPID_SRGSetWordSequenceData',
    'eLEXTYPE_USER', 'SpeechLoadOption', 'ISpeechRecoResultDispatch',
    'SPINTERFERENCE_TOOQUIET', 'SASClosed', 'DISPID_SABufferInfo',
    'ISpPhoneConverter', 'DISPID_SPPValue', 'SAFTADPCM_44kHzMono',
    'ISpeechPhraseRules', 'DISPID_SPPNumberOfElements',
    'DISPID_SPPChildren', 'SPPS_NotOverriden',
    'DISPID_SPEAudioSizeTime', 'SPEI_SR_BOOKMARK',
    'DISPID_SPARecoResult', 'DISPID_SpeechAudioBufferInfo', 'SVP_13',
    'eLEXTYPE_PRIVATE11', 'DISPID_SVGetAudioOutputs',
    'SPFM_OPEN_READONLY', 'DISPID_SRGCmdSetRuleIdState',
    'SPSEMANTICFORMAT', 'DISPID_SRState', 'SVF_Stressed', 'SPSLMA',
    'DISPID_SOTCGetDataKey', 'SPAO_RETAIN_AUDIO', 'ISpRecognizer2',
    'DISPID_SRSSupportedLanguages', 'SREHypothesis', 'ISpNotifySink',
    'eLEXTYPE_LETTERTOSOUND', 'SRTReSent',
    'DISPID_SGRSTPropertyValue', 'SP_VISEME_12', 'DISPID_SLWsCount',
    'DISPID_SVSInputWordPosition', 'DISPID_SRGIsPronounceable',
    'SVEAllEvents', 'SPTEXTSELECTIONINFO',
    'DISPID_SRGSetTextSelection', 'SP_VISEME_13',
    'DISPID_SRRTTickCount', 'SpeechRetainedAudioOptions',
    'SPWORDPRONOUNCEABLE', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SPEI_SR_AUDIO_LEVEL', 'STSF_CommonAppData',
    'DISPID_SOTGetAttribute', 'SpeechPropertyResponseSpeed',
    'SAFTADPCM_22kHzStereo', 'DISPID_SRCEEndStream',
    'DISPID_SRSCurrentStreamPosition',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPISaveToMemory', 'SVEPhoneme', 'SVSFIsNotXML',
    'SpeechEngineProperties', 'ISpPhoneticAlphabetConverter',
    'SpeechCategoryVoices', 'DISPID_SGRSAddWordTransition',
    'DISPID_SVSLastBookmark', 'DISPID_SpeechObjectTokenCategory',
    'SPSFunction', 'SPCONTEXTSTATE', 'ISpeechLexiconWord', 'SLTApp',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SASNonBlockingIO',
    ...
    'DISPID_SWFEExtraData', 'SAFTGSM610_11kHzMono', 'SpLexicon',
    'ISpXMLRecoResult', 'DISPID_SpeechRecoResultTimes',
    'SPEI_TTS_PRIVATE', 'ISpeechAudioBufferInfo', 'SPRST_INACTIVE',
    'SpeechRuleState', 'SPEI_MAX_SR', 'DISPID_SPAs_NewEnum',
    'SGDSActiveUserDelimited', 'DISPID_SRSNumberOfActiveRules',
    'ISpGrammarBuilder', 'DISPID_SPERequiredConfidence',
    'DISPID_SRGCmdLoadFromResource', 'SVP_11', 'DISPID_SVSpeak',
    'SpeechTokenContext', 'SpeechPropertyAdaptationOn',
    'SP_VISEME_11', 'DISPID_SRGetRecognizers', 'SAFT8kHz8BitStereo',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPCT_SLEEP',
    'SPWF_SRENGINE', 'SAFT12kHz16BitMono', 'SSSPTRelativeToEnd',
    'SVF_None', 'DISPID_SRCEStartStream', 'SPSMF_SAPI_PROPERTIES',
    'eLEXTYPE_RESERVED4', 'SPPHRASERULE', 'SPEI_RESERVED3',
    'DISPID_SLPs_NewEnum', 'ISpeechRecognizerStatus',
    'SREPropertyNumChange', 'DISPID_SRRTLength', 'eLEXTYPE_PRIVATE7',
    'SAFT44kHz16BitMono', 'DISPID_SRGCmdSetRuleState',
    'DISPIDSPTSI_ActiveLength', 'SPPS_Modifier', 'SPSHT_OTHER',
    'SpeechUserTraining', 'DISPID_SGRSTType', 'SAFTADPCM_11kHzMono',
    'DISPID_SRGDictationSetState', 'SP_VISEME_2', 'SVP_21',
    'DISPID_SAFGetWaveFormatEx', 'SPPHRASEREPLACEMENT',
    'SAFTCCITT_ALaw_22kHzMono', 'SPINTERFERENCE_TOOSLOW',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SLPSymbolic', 'SVPAlert',
    'SGRSTTTextBuffer', 'DISPID_SVSInputWordLength',
    'SPDKL_CurrentConfig', 'SAFT48kHz16BitMono', 'DISPID_SLPType',
    'SDTRule', 'DISPID_SpeechAudioFormat', 'SpeechAudioState',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SBSRead',
    'SpUnCompressedLexicon', 'DISPIDSPTSI_SelectionLength',
    'SVSFDefault', 'SDA_Two_Trailing_Spaces', 'SpShortcut', 'SVP_0',
    'DISPID_SRCESoundEnd', 'DISPID_SMSSetData', 'SPAS_RUN', 'SVP_5',
    'SpeechTokenKeyFiles', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SRSetPropertyNumber', 'SPAS_PAUSE',
    'DISPID_SRCAudioInInterferenceStatus', 'SPWAVEFORMATTYPE',
    'DISPID_SPEsItem', 'DISPID_SOTCreateInstance',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechCategoryAudioOut', 'SPPS_RESERVED3',
    'DISPID_SVGetProfiles', 'ISpStream', 'DISPID_SVWaitUntilDone',
    'eLEXTYPE_RESERVED10', 'SpeechVisemeType', 'DISPID_SLPsItem',
    'SPPHRASE', 'SWPUnknownWordUnpronounceable',
    'DISPID_SVSInputSentencePosition', 'SFTInput',
    'DISPID_SpeechLexiconPronunciation', 'SpFileStream',
    'SpeechDisplayAttributes', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SBSWrite', 'DISPID_SRCBookmark',
    'IInternetSecurityManager', 'DISPID_SRRPhraseInfo',
    'SPRECOCONTEXTSTATUS', 'SPDKL_LocalMachine', 'SDTAlternates',
    'SPRS_ACTIVE', 'SAFTDefault', 'SPSEMANTICERRORINFO',
    'DISPID_SGRSTsCount', 'DISPID_SPACommit',
    'SpeechEngineConfidence', 'SAFT11kHz8BitMono', 'SPAR_High',
    'DISPID_SDKSetStringValue', 'SPPS_RESERVED1',
    'DISPID_SPIElements', 'DISPID_SRGState', 'DISPID_SGRAddState',
    'SAFT32kHz16BitStereo', 'SWPKnownWordPronounceable',
    'eLEXTYPE_PRIVATE10', 'eLEXTYPE_PRIVATE19',
    'DISPID_SDKSetLongValue', 'SITooQuiet', 'SVP_19',
    'DISPID_SABIEventBias', 'ISpRecoResult', 'SAFT48kHz8BitMono',
    'ISpeechPhraseElement', 'SpeechGrammarTagWildcard',
    'STSF_LocalAppData', 'eLEXTYPE_RESERVED7', 'SPBO_NONE',
    'DISPID_SpeechRecoContext', 'DISPID_SpeechFileStream',
    'SAFT16kHz16BitMono', 'DISPID_SLWType', 'DISPID_SPRuleParent',
    'SpAudioFormat', 'SP_VISEME_6', 'eLEXTYPE_PRIVATE6',
    'SP_VISEME_14', 'SVEBookmark', 'eLEXTYPE_PRIVATE12',
    'ISpeechAudioStatus', 'SPFILEMODE', 'SECHighConfidence',
    'eLEXTYPE_PRIVATE20', 'SAFT16kHz16BitStereo',
    'ISpeechRecoGrammar', 'SECFIgnoreKanaType', 'DISPID_SRDisplayUI',
    'SGRSTTWord', 'DISPID_SOTRemove', 'ISpeechObjectTokens',
    'DISPID_SPRsItem', 'SpeechAudioProperties',
    'SAFT11kHz16BitStereo', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SAFType', 'SpeechCategoryAudioIn', 'SVP_9',
    'SAFTCCITT_uLaw_8kHzMono', 'SDKLCurrentConfig', 'SRESoundEnd',
    'DISPID_SpeechGrammarRules', 'DISPID_SOTDataKey', 'SVP_1',
    'SAFT32kHz16BitMono', 'DISPID_SVEEnginePrivate',
    'DISPID_SPRuleChildren', 'DISPID_SOTDisplayUI',
    'SpeechTokenKeyAttributes', 'tagSTATSTG', 'SPAS_STOP',
    'DISPID_SPANumberOfElementsInResult', 'ISpRecognizer3',
    'DISPID_SVSLastResult', 'DISPID_SRCVoice',
    'SAFTADPCM_11kHzStereo', 'SAFTExtendedAudioFormat',
    'DISPID_SpeechPhraseInfo', 'DISPID_SPPFirstElement',
    'DISPID_SLRemovePronunciation', 'DISPID_SLGenerationId',
    'SAFT8kHz16BitMono', 'ISpeechMemoryStream',
    'DISPID_SRCEAdaptation', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SVDisplayUI', 'SPEI_RECO_OTHER_CONTEXT', 'SSFMCreate',
    'SPPS_Interjection', 'SAFTCCITT_uLaw_44kHzStereo',
    'SVEWordBoundary', 'DISPID_SRGReset', 'SPEI_TTS_AUDIO_LEVEL',
    'SPPS_SuppressWord', 'SPINTERFERENCE_TOOLOUD', 'SRERecognition',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SAEventHandle',
    'DISPID_SVSPhonemeId', 'SVPNormal', 'SVSFPurgeBeforeSpeak',
    'DISPID_SWFEFormatTag', 'DISPID_SAVolume', 'DISPID_SPAsCount',
    'DISPID_SVEAudioLevel', 'DISPID_SGRsCount',
    'SAFT44kHz16BitStereo', 'SPVPRI_OVER', 'SVPOver',
    ...
    'DISPID_SPRulesCount', 'SGDSInactive', 'SpeechTokenValueCLSID',
    'SpeechCategoryPhoneConverters', 'SAFTADPCM_22kHzMono',
    'SPLO_STATIC', 'ISpPhoneticAlphabetSelection',
    'DISPID_SOTGetStorageFileName', 'ISpeechDataKey', 'SLODynamic',
    'DISPID_SpeechPhraseRules', 'SPSVerb', 'ISpObjectTokenCategory',
    'DISPID_SRGCommit', 'SPPHRASEPROPERTY', 'eLEXTYPE_PRIVATE4',
    'SPEI_MIN_TTS', 'SpTextSelectionInformation', 'SPFM_CREATE',
    'SpPhraseInfoBuilder', 'ISpeechPhraseInfoBuilder',
    'SPINTERFERENCE_NOISE', 'ISpRecoGrammar2', 'DISPID_SPIGrammarId',
    'SpeechInterference', 'SpeechRuleAttributes',
    'DISPID_SPRs_NewEnum', 'SpeechDataKeyLocation', 'SINone',
    'SRTExtendableParse', 'SpeechFormatType', 'DISPID_SLPsCount',
    'DISPID_SVAudioOutput', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpeechRecoEvents', 'SpeechTokenShellFolder',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVSpeakCompleteEvent',
    'ISpObjectWithToken', 'ISpRecoGrammar', 'SPDATAKEYLOCATION',
    'DISPID_SPPsCount', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpeechDiscardType', 'SREPrivate',
    'SPEI_SOUND_START', 'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPRFirstElement', 'SVP_16', 'DISPID_SPRuleFirstElement',
    ...
    '_ISpeechVoiceEvents', 'ISpeechLexiconWords', 'DISPID_SPRsCount',
    'DISPID_SPIAudioSizeBytes', 'SVSFParseAutodetect',
    'SpeechPartOfSpeech', 'DISPID_SRCERequestUI',
    'DISPID_SRRSaveToMemory', 'DISPID_SRGetPropertyNumber',
    'SECFIgnoreWidth', 'SpeechWordPronounceable',
    'ISpeechGrammarRules', 'DISPID_SRGRecoContext', 'SPSHORTCUTPAIR',
    ...
    'SITooFast', 'DISPID_SRSetPropertyString', 'SAFT48kHz16BitStereo',
    'SPSHT_EMAIL', 'DISPID_SRSCurrentStreamNumber', 'SPEI_UNDEFINED',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SpeechMMSysAudio',
    'SDTPronunciation', 'SPAUDIOOPTIONS', 'SPEI_SOUND_END',
    'SP_VISEME_3', 'DISPID_SVESentenceBoundary',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SLWsItem',
    'SpeechRegistryUserRoot', 'SRSActiveAlways',
    'SpeechVisemeFeature', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SpeechMemoryStream', 'SECFDefault', 'SPLOADOPTIONS',
    ...
    'DISPID_SPERetainedSizeBytes', 'DISPID_SRCESoundStart',
    'SP_VISEME_16', 'DISPID_SpeechLexiconWords', 'SPAUDIOBUFFERINFO',
    'DISPID_SRRAudio', 'ISpPhraseAlt', 'ISpRecognizer',
    'SpeechMicTraining', 'DISPID_SGRSTText',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SVEventInterests', 'SPSHORTCUTPAIRLIST',
    'DISPID_SVSpeakStream', 'SASRun', 'SVSFParseMask',
    'DISPID_SASState', 'DISPID_SRStatus', 'ISpeechRecoContext',
    'SRSEDone', 'DISPID_SOTGetDescription', 'DISPID_SGRsAdd',
    'SPEI_ADAPTATION', 'SVP_15', 'DISPID_SGRsCommitAndSave',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SpeechLexiconWord',
    'SPINTERFERENCE_NOSIGNAL', 'DISPID_SOTsCount', 'SPPS_RESERVED4',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SLWLangId',
    'SDTLexicalForm', 'SRERecoOtherContext', 'ISpShortcut', 'SPEVENT',
    'ISpEventSink', 'SINoise', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SOTId', 'SPRULE', 'SPPS_Function', 'SPEI_REQUEST_UI',
    'SAFT22kHz8BitMono', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SpeechBaseStream', 'DISPIDSPRG', 'DISPID_SPIReplacements',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SPRuleId',
    'DISPID_SVSRunningState', 'ISpResourceManager',
    'DISPID_SpeechGrammarRuleState', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpVoice', 'SSFMOpenReadWrite', 'eLEXTYPE_USER_SHORTCUT',
    'SAFT12kHz8BitStereo', 'SVSFIsFilename', 'DISPID_SRCResume',
    'SPRECOSTATE', 'DISPID_SVAudioOutputStream', 'SPSHORTCUTTYPE',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SpeechLexicon',
    'DISPID_SRGCmdLoadFromFile', 'SP_VISEME_19', 'SPPROPERTYINFO',
    'DISPID_SPPsItem', 'DISPID_SRAudioInput',
    'SpeechPropertyLowConfidenceThreshold', 'SPVPRI_ALERT',
    'ISpStreamFormat', 'SPSSuppressWord', 'ISequentialStream',
    'SPLEXICONTYPE', 'SpeechStreamSeekPositionType',
    'SPPS_Noncontent', 'DISPID_SMSGetData', 'DISPID_SRCEHypothesis',
    'DISPID_SVGetAudioInputs', 'DISPID_SPEs_NewEnum',
    'SAFT32kHz8BitStereo', 'SVSFParseSsml', 'DISPID_SGRsFindRule',
    'SpResourceManager', 'SVSFNLPSpeakPunc', 'WAVEFORMATEX',
    'SAFT8kHz16BitStereo', 'DISPID_SPIRetainedSizeBytes',
    'STCInprocHandler', 'DISPID_SpeechDataKey', 'DISPID_SGRsItem',
    'DISPID_SRGCmdLoadFromMemory', 'SVSFlagsAsync', 'SpWaveFormatEx',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SpeechAudio',
    'SVSFIsXML', 'SpeechAudioFormatGUIDWave', 'SPEI_SR_PRIVATE',
    'ISpNotifyTranslator', 'DISPID_SPRNumberOfElements',
    'SpeechRecognizerState', 'SpeechRunState', 'SpNullPhoneConverter',
    'SpeechPropertyResourceUsage', 'SPWT_DISPLAY', 'SPSNotOverriden',
    'UINT_PTR', 'SAFT8kHz8BitMono', 'SAFT12kHz8BitMono',
    'DISPID_SGRSTRule', 'SPSMF_UPS', 'SP_VISEME_4',
    'DISPID_SREmulateRecognition', 'SPFM_OPEN_READWRITE',
    'SAFTCCITT_uLaw_44kHzMono', '_RemotableHandle',
    'DISPID_SRGDictationUnload', 'DISPID_SGRsDynamic',
    'SPGRAMMARWORDTYPE', 'SAFT16kHz8BitStereo',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRCState',
    'STSF_FlagCreate', 'SpeechGrammarTagDictation', 'SRSInactive',
    'SRSActive', 'SGRSTTWildcard',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_START_INPUT_STREAM', 'SLTUser', 'SAFTCCITT_ALaw_8kHzStereo',
    'SRARoot', 'SAFTCCITT_ALaw_44kHzStereo', 'Speech_Max_Pron_Length',
    'ISpStreamFormatConverter', 'SPAR_Low', 'SPAR_Unknown',
    'DISPID_SDKCreateKey', 'eLEXTYPE_PRIVATE2',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SpeechObjectToken',
    'DISPID_SRRSpeakAudio', 'eWORDTYPE_ADDED', 'SPSHT_NotOverriden',
    'SpObjectTokenCategory', 'SAFT11kHz8BitStereo',
    'SPWT_PRONUNCIATION', 'SPPARTOFSPEECH', 'SP_VISEME_21',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechVoiceSkipTypeSentence',
    'ISpeechVoice', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SAFTNonStandardFormat', 'DISPID_SVEBookmark', 'SVSFParseSapi',
    'DISPID_SRCEFalseRecognition', 'DISPID_SRSClsidEngine',
    'DISPID_SpeechPhraseRule', 'SPXRO_SML',
    'SpeechTokenIdUserLexicon', 'ISpeechPhraseRule', 'SBOPause',
    'SSSPTRelativeToStart', 'ISpeechLexiconPronunciations',
    'DISPID_SWFEBitsPerSample', 'SPVISEMES', 'SPGS_EXCLUSIVE',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SPELexicalForm',
    'DISPID_SLWs_NewEnum', 'DISPID_SRCPause',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpMMAudioOut',
    'DISPID_SpeechAudioStatus', 'SDKLCurrentUser',
    'DISPID_SDKGetStringValue', 'SREAudioLevel', 'SRADynamic',
    'SPPS_RESERVED2', 'Speech_StreamPos_RealTime',
    'SPEI_SR_RETAINEDAUDIO', 'SPPS_Unknown', 'ISpeechLexicon',
    'SPEI_PHONEME', 'DISPID_SPPEngineConfidence',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPEPronunciation',
    'SAFT24kHz8BitStereo', 'SPGRAMMARSTATE', 'SRAONone',
    'DISPID_SDKGetlongValue', 'SpeechVoicePriority',
    'SPXRO_Alternates_SML', 'SpNotifyTranslator',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SBSSeek',
    'eLEXTYPE_MORPHOLOGY', 'Speech_StreamPos_Asap',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SpPhoneConverter',
    'SAFTText', 'SPCS_DISABLED', 'ISpLexicon',
    'ISpeechPhraseProperty', 'DISPID_SOTCategory', 'SPWORDLIST',
    'DISPID_SGRSAddSpecialTransition', 'ISpMMSysAudio',
    'STSF_AppData', 'DISPID_SPPConfidence', 'SPRST_ACTIVE',
    'SRATopLevel', '_ISpeechRecoContextEvents', 'DISPID_SPPId',
    'SPCT_SUB_DICTATION', 'SAFT16kHz8BitMono'
]

_check_version('1.3.1', 1718170111.801060)
